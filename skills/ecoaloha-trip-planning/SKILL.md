...
3. Call search_experiences with destinationId and the requested currency, interest, date, budget, or duration.
4. Compare up to five returned IDs with compare_experiences. Treat missing fields as unknown.
